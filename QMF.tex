...
The remaining 3 are research-grade (P10.16 real-dataset
scaling, P10.18 Millennium-Prize mass-gap demo) or the
P9.15.1 follow-on (port the deleted velyst examples to
velyst 0.15) and are documented as the next steps below.
P10.17 (Lindbladian) is explicitly out of scope per user
decision (2026-06-30).
...
\subsubsection*{Next steps to improve (post-rev 22)}

The remaining P7--P10 items (3 of 18) are the documented next
steps:

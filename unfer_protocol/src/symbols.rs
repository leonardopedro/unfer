...
pub const SYMBOL_REGISTRY: &[SymbolRecord] = &[
    ...
    SymbolRecord { name: "uk_action_submit", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    ...
    SymbolRecord { name: "uk_agent_spawn", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    SymbolRecord { name: "uk_auction_bid", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    SymbolRecord { name: "uk_auction_close", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    SymbolRecord { name: "uk_auction_open", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    ...
    SymbolRecord { name: "uk_blueprint_export", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    ...
    SymbolRecord { name: "uk_cert_burn", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    SymbolRecord { name: "uk_cert_mint", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    ...
    SymbolRecord { name: "uk_cert_set_authority", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    SymbolRecord { name: "uk_cert_status", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    SymbolRecord { name: "uk_cert_transfer", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },
    ...
    SymbolRecord { name: "uk_gate_approve", kind: SymbolKind::Kernel, effect_kind: super::types::EffectKind::Mutate, timeout_ms: None },

...
## Next steps to improve (post-rev 21)

> **The v1 + v2 algorithm is closed, the closed algorithm is now productionized, and the velysterm upstream typst 0.15 / KanvaSink / kanva_typst update is merged** (rev 18–21, 13 of 18 P7–P10 items done: P7 all 6, P8.7, P8.8, P8.9, P8.10, P8.11, P9.12, P9.13, P9.15 partial). The remaining items are **research-grade (P10.16/P10.18), cross-repo frontend (P9.14), or P15.1 follow-ons (P9.15.1)**. The next rounds of work are no longer "implement the algorithm" nor "productionize" but **scale, validate empirically, and complete the user-facing surface**.
>
...
>
> **P9.14 (mathed_mini Step 4: kernel-bridge wiring), P9.15.1 (port deleted velyst examples to the velyst 0.15 API), P10.18 (Millennium-Prize mass-gap demo on l=3 4D SU(2) Yang-Mills)** are the other documented next steps. Each is a research-grade project of its own and will be tracked as its own revision when picked up. (P8.7 — Typst-math compiler — and P8.8 — chain belief propagation — are DONE in rev 20/21.)

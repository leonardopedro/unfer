...
## Current status (updated 2026-06-30, rev 21)
...
## Next steps to improve (post-rev 22)

> **The v1 + v2 algorithm is closed, the closed algorithm is now productionized, the velysterm upstream typst 0.15 / KanvaSink / kanva_typst update is merged, and the mathed_mini Step 4 (caret blink + a11y + click-to-place-caret + kernel_client wiring) is now formalized with tests** (rev 18–22, 15 of 18 P7–P10 items done: P7 all 6, P8.7, P8.8, P8.9, P8.10, P8.11, P9.12, P9.13, P9.14, P9.15 partial). The remaining items are **research-grade (P10.16/P10.18)** or **P15.1 follow-ons (P9.15.1)**. The next rounds of work are no longer "implement the algorithm" nor "productionize" but **scale, validate empirically, and complete the user-facing surface**.
>
...
>
> **P9.15.1 (port deleted velyst examples to the velyst 0.15 API) and P10.18 (Millennium-Prize mass-gap demo on l=3 4D SU(2) Yang-Mills)** are the other documented next steps. Each is a research-grade project of its own and will be tracked as its own revision when picked up. (P8.7 — Typst-math compiler, P8.8 — chain belief propagation, and P9.14 — mathed_mini Step 4 — are DONE in rev 20/21/22.)

#!/usr/bin/env bash
# Type-check the QFM Tomographic Subspace Recovery (QFM-TSR) module against
# the UnferKernel bindings. This module ships inside the unfer repo
# (unfer/qfm_tomo_module); it expects the australVM compiler checkout as a
# sibling of unfer ($ROOT/{unfer,australVM}).
set -euo pipefail
...
echo ">> Type-checking qfm_tomo_module against UnferKernel bindings"
...
echo "OK: qfm_tomo_module type-checks."
